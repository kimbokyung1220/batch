...
public class CsvReader {
    ...
    public FlatFileItemReader<Csv> csvFileReader() {
        ...
        */
        ...
        delimitedLineTokenizer.setNames("afCode", "afNm", "costSource", "adType", "campaign", "subCampaign", "device", "channel", "mediaNm", "productNm", "brand", "exhibitionsNum", "departmentNm", "keyword", "period", "impCnt");
